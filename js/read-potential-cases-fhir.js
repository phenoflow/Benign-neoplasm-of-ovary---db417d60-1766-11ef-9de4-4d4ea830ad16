...
(async () => {
  ...
  await fs.writeFile("benign-neoplasm-of-ovary-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("benign-neoplasm-of-ovary-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
